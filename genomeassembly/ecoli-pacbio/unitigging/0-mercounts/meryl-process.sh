...
if [ ! -e ./ecoli.ms22/merylIndex ] ; then
  /Users/pfb2024/PFB_problemsets/genomeassembly/canu-2.2/bin/meryl threads=3 memory=2 \
    greater-than 1 \
...
if [ ! -e ./ecoli.ms22.histogram ] ; then
  /Users/pfb2024/PFB_problemsets/genomeassembly/canu-2.2/bin/meryl threads=1 memory=1 \
...
if [ ! -e ./ecoli.ms22.ignore.gz ] ; then
  ...
  totKmers=`/Users/pfb2024/PFB_problemsets/genomeassembly/canu-2.2/bin/meryl statistics ./ecoli.ms22 | grep present | awk '{ print $2 }'`
